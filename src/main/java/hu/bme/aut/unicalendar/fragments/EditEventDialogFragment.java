...
public class EditEventDialogFragment extends DialogFragment {
    ...
    public EditEventDialogFragment setListener(EditItemDialogListener listener) {
    ...
    private View getContentView() {
        ...
        new AsyncTask<Void, Void, List<String>>() {
            ...
            protected void onPostExecute(List<String> rows) {
                ...
                eventSubjectSpinner.setSelection(((ArrayAdapter)eventSubjectSpinner.getAdapter()).getPosition(item.subject));
            }
        }.execute();
        ...
        new AsyncTask<Void, Void, List<String>>() {
            ...
            protected void onPostExecute(List<String> rows) {
                ...
                eventRequirementSpinner.setSelection(((ArrayAdapter)eventRequirementSpinner.getAdapter()).getPosition(item.requirement));
            }
        }.execute();
        ...
        etEventNotification.setText(item.notification.toString());
        return layout;
    }

    public EditEventDialogFragment setItem(Event item) {
        this.item = item;
        return this;
    }
}
